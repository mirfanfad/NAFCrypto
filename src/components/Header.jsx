  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between mx-auto">
        <h1 className="text-2xl font-bold">NAFCrypto</h1>
          ...
          {account ? (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center px-4 py-2 space-x-2 bg-white rounded-full bg-opacity-20"
              >
                <Wallet size={18} />
                <span className="w-32 text-sm truncate">{account}</span>
                <ChevronDown size={18} />
              </button>
              {dropdownOpen && (
                <div
